...
const nagori_info = `
                <div id="chara">
                    <div>
                        ...
                        <div id="info">
                            年齢 : 17(本人談)<br>
                            性別 : 不明<br>
                            サイズ：横・奥行30cm,縦8cm<br>
                            重量 : 56kg
                        </div>
                        <div id="inst">
                            →<a href="https://bowlroll.net/file/337141" style="padding:3px" target="_blank">Download</a>
                            <audio id="audio" src="sample/赤とんぼ_nagori.wav"></audio>
                            <br><br>
                    ...
                    <div>
                        <div class="about">風邪ひいたときに作った音源。<br>音域によっては中性的にも女性的にも聴こえると思います。<br>
                            ...
                            <div style="display:flex;">
                                ...
                                <table style="font-size: 12px; width: 170px; height: 10px;">
                                    <tr>
                                        <th>【特殊音素】</th>
                                    </tr>
                                    <tr>
                                        <th style="border-bottom: none;">息</th>
                                        <td style="border-bottom: none;">br1,br2,br3</td>
                                    </tr>
                                    <tr>
                                        <th style="border-bottom: none;">語尾息</th>
                                        <td style="border-bottom: none;">x R吐,x R吸</td>
                                    </tr>
                                    <tr>
                                        <th style="border-bottom: none;">咳</th>
                                        <td style="border-bottom: none;">coff1,coff2,coff3</td>
                                    </tr>
                                </table>
                                <div style="text-align: center;">
                                    <div style="font-size: 12px; font-weight: bold;">【立ち絵+設定画】</div>
                                    <a class="synopsis" href="other/像音ナゴリ_資料.zip" download
                                        onclick="return confirm('配布資料を保存しますか？🐟')">
                                        <img src="imag/nagori/nagori_file.png" alt=""></a>
                                </div>
                ...
                <div style="height:0px;">
                    <div class="draggable" style="left:-100px; top:-50px; width: 240px; z-index: 5;">
                    ...
                    <div class="draggable" style="left:30px; top:-210px; width: 240px; z-index: 3;">
                        <div class="tabTitle" style="background: blue; color: white;">　</div>
                        <div class="tabDesign" style="border-color: blue;"><img src="imag/nagori/nagori_back.png" alt=""
                                class="visual"></div>
                    </div>
                    <div class="draggable" style="left:400px; top:-870px; width: 250px; z-index: 5;">
                    ...
                    <div class="draggable" style="left:-130px; top:-410px; width: 80px; z-index: 5; height: 0px;">
                        <div class="tabTitle" style="background: blue;">　</div>
                        <div class="tabDesign" style="border-color: blue; padding: 0px;">
                            <img src="imag/.png" style="width: 80px; height: 50px;" onclick="triggerCrash()">
                        </div>
                    </div>
                    <div class="draggable" style="left:-170px; top:-690px; width: 120px; z-index: 5; height: 0px;">
                        <div class="tabTitle" style="background: blue;">　</div>
                        <div class="tabDesign" style="border-color: blue; padding: 0px;">
                            <img src="imag/.png" style="width: 50px; height: 50px;">
                        </div>
                    </div>
                    <div class="draggable" style="left:820px; top:-640px; width: 110px; z-index: 5; height: 0px;">
                        <div class="tabTitle" style="background: blue;">　</div>
                        <div class="tabDesign" style="border-color: blue; padding: 0px;">
                ...
                <div style="height: 0px;">
                    <!--pc-->
                    <div class="draggable" style="left:600px; top:-430px; width: 140px; height: 0px; z-index:5;"><img
                            src="imag/nagori/gif/pc.gif" alt="" width="140px"></div>
                    <!--folder-->
                    <div class="draggable" style="left:280px; top:-480px; width: 100px; height: 0px; z-index:5;"><img
                            src="imag/nagori/gif/folder.gif" alt="" width="100px"></div>
                    <div class="draggable" style="left:850px; top:20px; width: 100px; height: 0px; z-index:5;"><img
                            src="imag/nagori/gif/folder.gif" alt="" width="100px"></div>
                    <!--fdd-->
                    <div class="draggable" style="left:-150px; top:130px; width: 100px; height: 0px; z-index:5;"><img
                            src="imag/nagori/gif/fdd.gif" alt="" width="100px"></div>
                    <!--star-->
                    <div class="draggable" style="left:-130px; top:-370px; width: 80px; height: 0px; z-index:5;"><img
                            src="imag/nagori/gif/star.gif" alt="" width="80px"></div>
                    <div class="draggable"
                        style="left:-60px; top:-320px; width: 50px; height: 0px; z-index:5; rotate: -5rad;"><img
                            src="imag/nagori/gif/star.gif" alt="" width="50px"></div>
                    <div class="draggable" style="left:820px; top:-310px; width: 50px; height: 0px; z-index:5;"><img
                            src="imag/nagori/gif/star.gif" alt="" width="50px"></div>

                </div>
                <!--nagori-->
                <div class="draggable" style="left:590px; top:-300px; width: 350px; height: 0px; z-index:-5px;">
                ...
                <div style="height: 0px; width: 0px;">
                    <!--kurage-->
                    <div class="deco"
                        style="height: 0px; left:600px; top:-430px; width: 300px; transform: rotate(60deg); z-index:-1">
                        <img src="imag/free/penga/penga-0136.png" style="width: 500px;">
                    </div>
                    <!--GIF-->
                    <div class="deco" style=" left: -200px; top: -340px; z-index: -5; height: 0px;">
                        <img src="imag/nagori/gif/ng01.gif" alt="" width="350px">
                    </div>
                    <div class="deco" style=" left: -150px; top: -200px; z-index: -10; height: 0px;">
                        <img src="imag/nagori/gif/ng04.gif" alt="" width="520px" height="400px">
                    </div>
                    <div class="deco" style=" left: 520px; top: 90px; z-index: -5; height: 0px;">
                        <img src="imag/nagori/gif/ng05.gif" alt="" width="350px">
                    </div>
                    <div class="deco" style=" left: 450px; top: -30px; z-index: -5; height: 0px;">
                        <img src="imag/nagori/gif/ng02.gif" alt="" width="200px">
                    </div>
                    <div class="deco" style=" left: 480px; top: -440px; z-index: -15; height: 0px;">
                        <img src="imag/nagori/gif/ng03.gif" alt="" width="450px" height="450px">
                    </div>
                    <div class="deco" style=" left: -210px; top: 140px; z-index: -5; height: 0px;">
                        <img src="imag/nagori/gif/ng06.gif" alt="" width="550px" height="140px">
                    </div>
                </div>
                <!-- -->
                <div style="position: relative; top: -144px; left: -105px; height: 0px;">
                    <a href="secret/news.html">
                        <div style="background:red; height: 1px; width: 1px;"></div>
                    </a>
                </div>
`;
...
const log_info = `
                <div id="chara" style="color:rgb(0,255,0); height: 0px;">
                    ...
                    <div>
                        <div class="about" style="border-bottom: 1px rgb(0,255,0) solid;">パソコンの周辺機器から生まれた無生物音源。<br>母音
                            ...
                            本家UTAUでの動作を基準に制作しているためOpenUtauではbre50以上をかけることをオススメします。<br>
                            <br>
                            <div style="display:flex;">
                                <table style="font-size: 12px; width: 220px; height: 10px;">
                                    <tr>
                                        <th style=" border-bottom: 1px solid rgb(0,255,0);">【特殊音素】</th>
                                    </tr>
                                    <tr>
                                        <th style="border-bottom: none;">息</th>
                                    ...
                                    <tr>
                                        <th style="border-bottom: none;">キーボード</th>
                                        <td style="border-bottom: none;">typ1,typ2, typ_L1,typ_L2</td>
                                    </tr>
                                    <tr>
                                        <th style="border-bottom: none;">マウス</th>
                                        <td style="border-bottom: none;">click1,click2,click3</td>
                                    </tr>
                                </table>
                                <div style="text-align: center;">
                                    <div style="font-size: 12px; font-weight: bold;">【立ち絵+設定画】</div>
                                    <a class="synopsis" href="other/接路音ログ_資料.zip" download
                                        onclick="return confirm('配布資料を保存しますか？🔌')">
                                        <img src="imag/log/log_file.png" alt=""></a>
                                </div>
                            </div>
                        </div>
                        <div class="about" style="border-bottom: 1px rgb(0,255,0) solid;">
                            出自不明のヒューマノイド。開発経緯や製造元の記録は確認されていない。自身から伸びるケーブルで(勝手に)あらゆる機械への接続を試みている。<br>だいぶ変わってるが悪いヤツではない。たぶん。
                        </div>
                    </div>
                </div>
                ...
                <div style="height: 0px;">
                    ...
                    <div style="height: 0px;">
                        ...
                        <div class="deco"
                            style="left:-200px; top: -600px; width: 10px; transform: rotate(-7deg); z-index:1; height: 0px;">
                            <img src="imag/log/log_code/c10223.png" style="width: 200px;">
                        </div>
                        <div
                            style="position: absolute; top: -120px; left:-200px; width: 10px; z-index:-1; height: 0px;">
                            <img src="imag/log/log_code/c10224.png" style="width: 800px; transform: rotate(-180deg);">
                        </div>
                        <div class="deco"
                            style="left:-200px; top:-600px; width: 10px; transform: rotate(5deg); z-index:1; height: 0px;">
                            <img src="imag/log/log_code/c10222g.png"
                                style="width: 100px; filter: brightness(0.8) contrast(1.2);">
                        </div>
                        <div class="deco"
                            style="left:500px; top: -600px; width: 10px; transform: rotate(-7deg); z-index:1">
                            <img src="imag/log/log_code/c10223.png" style="width: 200px;">
                        </div>
                        <div
                            style="position: relative; top: -1100px; left:550px; width: 10px; z-index:-1; height: 0px;">
                        ...
                        <div
                            style="position: relative; right:-300px; top:-1200px; width: 10px; z-index:-4; height: 0px;">
                            <img src="imag/log/log_code/c10223.png"
                                style="width: 140px; transform:rotate(15deg) scale(-1, 1);">
                        </div>
                    </div>
                    ...
                    <div style="height: 0px;">
                        <!--left-->
                        <div class="draggable" style="left:670px; top:-0px; z-index:5; width: 232px;">
                            <div class="tabTitle"
                        ...
                        <!--right-->
                        <div class="draggable" style="left:-220px; top:0px; z-index:5; width: 232px;">
                            <div class="tabTitle"
                                style="background:black; border: solid 1px rgb(0,255,0); color: rgb(0,255,0);">　</div>
                            <div class="tabDesign" style="border-color: rgb(0,255,0); padding: 0px; background: black;">
                        ...
                        <!--eye-->
                        <div class="draggable" style="left:80px; top:-80px; z-index:8; width: 122px;">
                            <div class="tabTitle"
                                style="background:black; border: solid 1px rgb(0,255,0); color: rgb(0,255,0);">　</div>
                            <div class="tabDesign" style="border-color: rgb(0,255,0); padding: 0px; background: black;">
                        ...
                        <!--Log-->
                        <div class="draggable" style="left:400px; top:-260px; z-index:0; width: 502px;">
                            <div class="tabTitle"
                                style="background:black; border: solid 1px rgb(0,255,0); color: rgb(0,255,0);">Tsugurone
                                Log</div>
                    ...
                    <div style="height: 0px;">
                        <!--esc-->
                        <div class="draggable" style="left:-100px; top:-50px; z-index:15; width: 60px;">
                            <img src="imag/log/key/key_esc.png" alt="" width="60">
                        </div>
                        <!--shift-->
                        <div class="draggable" style="left:-180px; top:350px; z-index:15; width: 120px;">
                            <img src="imag/log/key/key_shift.png" alt="" width="120">
                        </div>
                        <!--alt-->
                        <div class="draggable" style="left:760px; top:320px; z-index:15; width: 90px;">
                            <img src="imag/log/key/key_alt.png" alt="" width="90">
                        </div>
                        <!--back-->
                        <div class="draggable" style="left:560px; top:-270px; z-index:15; width: 60px;">
                            <img src="imag/log/key/key_backspace.png" alt="" width="60" style="filter: contrast(1.2);">
                        </div>
                        <!--enter-->
                        <div class="draggable" style="left:580px; top:-130px; z-index:15; width: 120px;">
                        ...
                        <!--cursol-->
                        <div class="draggable" style="left:30px; top:0px; z-index:15; width: 15px;">
                            <img src="imag/log/key/cursol.png" alt="" width="15">
                        </div>
                        <!--cursol-->
                        <div class="draggable" style="left:45px; top:-10px; z-index:15; width: 15px;">
                            <img src="imag/log/key/cursol.png" alt="" width="15">
                        </div>
                        <!--cursol-->
                    ...
                    <!--click-->
                    <div class="draggable" style="left:-50px; top:320px; width: 180px; z-index:5;">
                        <div class="tabTitle"
...
const ushio_info = `<div id="chara">
                    ...
                    <div>
                        <div class="about">鯨の鳴き声の動物(無生物系)音源。<br>母音 : 鯨の鳴き声<br>子音 : 鯨の鳴き声, 波の音<br><br>ウィスパーで柔らかい少女音源。<br>
                            <br>
                            <div style="display:flex;">
                                <table style="font-size: 12px; width: 170px; height: 10px;">
                                    <tr>
