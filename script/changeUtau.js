...
const nagori_info = `
                    ...
                    <div style="position: relative; top: -110px; left: -120px;">
                        <a href="secret/news.html"><div style="height: 10px; width: 10px;"></div></div></a>
                    </div>`;
...
const log_info = `
                ...
                <div style="height: 0px;">
                    ...
                    <div style="height: 0px;">
                        <!--esc-->
                        <div class="draggable" style="left:-100px; top:30px; z-index:15; width: 60px;">
                            <img src="imag/log/key/key_esc.png" alt="" width="60">
                        </div>
                        <!--shift-->
                        <div class="draggable" style="left:-80px; top:440px; z-index:15; width: 120px;">
                    ...
                    <!--click-->
                    <div class="draggable" style="left:0px; top:320px; width: 180px; z-index:5;">
                        <div class="tabTitle"
